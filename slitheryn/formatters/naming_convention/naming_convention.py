...
from slitheryn.core.declarations import Modifier, Event
from slitheryn.core.solidity_types import UserDefinedType, MappingType
from slitheryn.core.declarations import Enum, Contract, Structure, Function
from slitheryn.core.solidity_types.elementary_type import ElementaryTypeName
from slitheryn.core.variables.local_variable import LocalVariable
from slitheryn.formatters.exceptions import FormatError, FormatImpossible
from slitheryn.formatters.utils.patches import create_patch
