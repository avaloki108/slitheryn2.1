from slitheryn.core.declarations.solidity_variables import SOLIDITY_FUNCTIONS
from slitheryn.core.expressions import BinaryOperationType, UnaryOperationType
