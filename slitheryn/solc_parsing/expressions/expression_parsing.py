...
import slitheryn.core.expressions.type_conversion
...
from slitheryn.core.expressions.binary_operation import (
    BinaryOperation,
    BinaryOperationType,
)
...
from slitheryn.solc_parsing.expressions.find_variable import find_variable
from slitheryn.solc_parsing.solidity_types.type_parsing import UnknownType, parse_type
...
def parse_call(
    ...
    slitheryn.core.expressions.call_expression.CallExpression,
    slitheryn.core.expressions.type_conversion.TypeConversion,
]:
    src = expression["src"]
