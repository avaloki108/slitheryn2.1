...
from slitheryn.core.declarations.solidity_variables import (
    SolidityFunction,
    SolidityVariable,
...
from slitheryn.utils.type import convert_type_for_solidity_signature_to_string
from slitheryn.utils.utils import unroll


# pylint: disable=import-outside-toplevel,too-many-instance-attributes,too-many-statements,too-many-lines

if TYPE_CHECKING:
    from slitheryn.core.declarations import Contract, FunctionContract
    from slitheryn.core.cfg.node import Node, NodeType
    from slitheryn.core.variables.variable import Variable
    from slitheryn.slithir.variables.variable import SlithIRVariable
    from slitheryn.slithir.variables import LocalIRVariable
...
class Function(SourceMapping, metaclass=ABCMeta):  # pylint: disable=too-many-public-methods
    ...
    def can_reenter(self, callstack: Optional[List[Union["Function", "Variable"]]] = None) -> bool:
        ...
        :return bool:
        """
        from slitheryn.slithir.operations import Call
    ...
    def return_values(self) -> List["SlithIRVariable"]:
        ...
        from slitheryn.slithir.operations import Return
        from slitheryn.slithir.variables import Constant
    ...
    def _solidity_variable_in_binary(node: "Node") -> List[SolidityVariable]:
        from slitheryn.slithir.operations.binary import Binary
    ...
    def _solidity_variable_in_internal_calls(node: "Node") -> List[SolidityVariable]:
        from slitheryn.slithir.operations.internal_call import InternalCall
    ...
    def _get_last_ssa_variable_instances(
        ...
        from slitheryn.slithir.variables import ReferenceVariable
        from slitheryn.slithir.operations import OperationWithLValue
        from slitheryn.core.cfg.node import NodeType
    ...
    def _unchange_phi(ir: "Operation") -> bool:
        from slitheryn.slithir.operations import Phi, PhiCallback
    ...
    def _fix_phi_entry(
        ...
        from slitheryn.slithir.variables import Constant, StateIRVariable, LocalIRVariable
    ...
    def fix_phi(
        ...
        from slitheryn.slithir.operations import InternalCall, PhiCallback, Phi
        from slitheryn.slithir.variables import StateIRVariable, LocalIRVariable
