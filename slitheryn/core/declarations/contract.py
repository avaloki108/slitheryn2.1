...
from slitheryn.utils.using_for import USING_FOR, merge_using_for
from slitheryn.core.declarations.function import Function, FunctionType, FunctionLanguage
from slitheryn.utils.erc import (
    ERC20_signatures,
    ERC165_signatures,
    ERC223_signatures,
    ERC721_signatures,
...
from slitheryn.utils.tests_pattern import is_test_contract
...
if TYPE_CHECKING:
    ...
    from slitheryn.slithir.operations import HighLevelCall, LibraryCall
    from slitheryn.slithir.variables.variable import SlithIRVariable
    from slitheryn.core.variables import Variable, StateVariable
    ...
    from slitheryn.core.solidity_types import TypeAliasContract
...
class Contract(SourceMapping):  # pylint: disable=too-many-public-methods
    ...
    def is_upgradeable_proxy(self) -> bool:
        ...
        from slitheryn.slithir.operations import LowLevelCall
    ...
    def convert_expression_to_slithir_ssa(self) -> None:
        ...
        :return:
        """
        from slitheryn.slithir.variables import StateIRVariable
