...
from slitheryn.core.declarations import SolidityFunction, EnumContract, StructureContract
...
from slitheryn.core.solidity_types import MappingType, ArrayType
...
from slitheryn.slithir.operations import NewContract, TypeConversion, SolidityCall, InternalCall
from slitheryn.tools.flattening.export.export import (
    Export,
    export_as_json,
    save_to_zip,
    save_to_disk,
