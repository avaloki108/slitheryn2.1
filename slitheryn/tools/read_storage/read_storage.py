...
from slitheryn.core.declarations import Contract, Structure
from slitheryn.core.solidity_types import ArrayType, ElementaryType, MappingType, UserDefinedType
