...
from slitheryn.core.declarations import Contract
from slitheryn.tools.properties.addresses.address import Addresses
from slitheryn.tools.properties.platforms.echidna import generate_echidna_config
from slitheryn.tools.properties.properties.ercs.erc20.properties.burn import (
    ERC20_NotBurnable,
    ERC20_Burnable,
)
from slitheryn.tools.properties.properties.ercs.erc20.properties.initialization import ERC20_CONFIG
from slitheryn.tools.properties.properties.ercs.erc20.properties.mint import ERC20_NotMintable
from slitheryn.tools.properties.properties.ercs.erc20.properties.mint_and_burn import (
    ERC20_NotMintableNotBurnable,
)
from slitheryn.tools.properties.properties.ercs.erc20.properties.transfer import (
    ERC20_Transferable,
    ERC20_Pausable,
)
from slitheryn.tools.properties.properties.ercs.erc20.unit_tests.truffle import generate_truffle_test
from slitheryn.tools.properties.properties.properties import (
    property_to_solidity,
    Property,
)
from slitheryn.tools.properties.solidity.generate_properties import (
    generate_solidity_properties,
    generate_test_contract,
    generate_solidity_interface,
)
from slitheryn.utils.colors import red, green
