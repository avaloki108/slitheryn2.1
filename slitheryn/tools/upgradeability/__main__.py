...
from slitheryn.utils.output import output_to_json
from slitheryn.tools.upgradeability.checks import all_checks
from slitheryn.tools.upgradeability.checks.abstract_checks import (
    AbstractCheck,
    CheckClassification,
)
from slitheryn.tools.upgradeability.utils.command_line import (
