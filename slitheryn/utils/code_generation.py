...
from slitheryn.utils.type import (
...
from slitheryn.core.declarations import Structure, StructureContract, Enum, Contract

if TYPE_CHECKING:
    from slitheryn.core.declarations import FunctionContract, CustomErrorContract
