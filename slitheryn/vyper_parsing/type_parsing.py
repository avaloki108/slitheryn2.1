...
from slitheryn.core.declarations import FunctionContract, Contract
from slitheryn.vyper_parsing.ast.types import Name, Subscript, Call, Index, Tuple
...
def parse_type(
    ...
    from slitheryn.vyper_parsing.expressions.expression_parsing import parse_expression
    ...
    if isinstance(annotation, Name):
        ...
        from slitheryn.core.declarations.structure import Structure
        from slitheryn.core.variables.structure_variable import StructureVariable
