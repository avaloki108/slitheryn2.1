...
from slitheryn.vyper_parsing.variables.structure_variable import StructureVariableVyper
from slitheryn.vyper_parsing.ast.types import StructDef, AnnAssign
