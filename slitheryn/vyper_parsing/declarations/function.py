...
from slitheryn.core.cfg.node import NodeType, link_nodes, Node
from slitheryn.core.cfg.scope import Scope
from slitheryn.core.declarations.function import (
    Function,
    FunctionType,
)
from slitheryn.core.declarations.function import ModifierStatements
...
from slitheryn.vyper_parsing.cfg.node import NodeVyper
from slitheryn.solc_parsing.exceptions import ParsingError
from slitheryn.vyper_parsing.variables.local_variable import LocalVariableVyper
...
if TYPE_CHECKING:
    ...
    from slitheryn.vyper_parsing.declarations.contract import ContractVyper
