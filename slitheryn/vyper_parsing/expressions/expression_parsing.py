...
from slitheryn.core.declarations import SolidityFunction, FunctionContract
...
from slitheryn.vyper_parsing.expressions.find_variable import find_variable
from slitheryn.vyper_parsing.type_parsing import parse_type
from slitheryn.all_exceptions import ParsingError
from slitheryn.vyper_parsing.ast.types import (
    Int,
    Call,
    Attribute,
    Name,
