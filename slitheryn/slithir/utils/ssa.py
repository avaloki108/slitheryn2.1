...
import slitheryn.slithir.variables.tuple_ssa
...
from slitheryn.core.declarations.modifier import Modifier
...
from slitheryn.slithir.operations.operation import Operation
...
def add_ssa_ir(
    ...
    all_state_variables_instances: Dict[
        str, slitheryn.slithir.variables.state_variable.StateIRVariable
    ],
) -> None:
    """
