...
from slitheryn.analyses.data_dependency.data_dependency import get_dependencies, SUPPORTED_TYPES
from slitheryn.slithir.variables import TemporaryVariable, ReferenceVariable
