...
from slitheryn.core.compilation_unit import SlitherCompilationUnit, Language
from slitheryn.core.declarations import Contract
from slitheryn.formatters.exceptions import FormatImpossible
from slitheryn.formatters.utils.patches import apply_patch, create_diff
from slitheryn.utils.colors import green, yellow, red
from slitheryn.utils.comparable_enum import ComparableEnum
