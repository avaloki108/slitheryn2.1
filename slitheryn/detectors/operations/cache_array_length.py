...
from slitheryn.core.expressions import BinaryOperation, Identifier, MemberAccess, UnaryOperation
...
from slitheryn.slithir.operations import Length, Delete, HighLevelCall
