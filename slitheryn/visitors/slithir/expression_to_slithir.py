...
from slitheryn.core import expressions
...
from slitheryn.core.expressions import (
    AssignmentOperation,
...
from slitheryn.core.expressions.binary_operation import BinaryOperation
from slitheryn.core.expressions.expression import Expression
from slitheryn.core.expressions.index_access import IndexAccess
from slitheryn.core.expressions.literal import Literal
from slitheryn.core.expressions.new_array import NewArray
from slitheryn.core.expressions.new_contract import NewContract
from slitheryn.core.expressions.tuple_expression import TupleExpression
from slitheryn.core.expressions.unary_operation import UnaryOperation
from slitheryn.core.solidity_types import ArrayType, ElementaryType, TypeAlias, UserDefinedType
from slitheryn.core.solidity_types.type import Type
from slitheryn.core.variables.local_variable import LocalVariable
from slitheryn.core.variables.local_variable_init_from_tuple import LocalVariableInitFromTuple
...
from slitheryn.slithir.tmp_operations.argument import Argument
...
from slitheryn.slithir.variables import (
    Constant,
    ReferenceVariable,
    TemporaryVariable,
    TupleVariable,
)
from slitheryn.visitors.expression.expression import ExpressionVisitor
...
class ExpressionToSlithIR(ExpressionVisitor):
    ...
    def __init__(self, expression: Expression, node: "Node") -> None:
        from slitheryn.core.cfg.node import NodeType  # pylint: disable=import-outside-toplevel
