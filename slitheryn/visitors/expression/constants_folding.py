...
from slitheryn.core.variables import Variable
from slitheryn.utils.integer_conversion import convert_string_to_fraction, convert_string_to_int
from slitheryn.visitors.expression.expression import ExpressionVisitor
from slitheryn.core.solidity_types.elementary_type import ElementaryType
...
class ConstantFolding(ExpressionVisitor):
    ...
    def _post_identifier(self, expression: Identifier) -> None:
        from slitheryn.core.declarations.solidity_variables import SolidityFunction
        from slitheryn.core.declarations.enum import Enum
        from slitheryn.core.solidity_types.type_alias import TypeAlias
    ...
    def _post_call_expression(self, expression: expressions.CallExpression) -> None:
        from slitheryn.core.declarations.solidity_variables import SolidityFunction
        from slitheryn.core.declarations.enum import Enum
        from slitheryn.core.solidity_types import TypeAlias
    ...
    def _post_member_access(self, expression: expressions.MemberAccess) -> None:
        ...
        from slitheryn.core.solidity_types import UserDefinedType, TypeAlias
